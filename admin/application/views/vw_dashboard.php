				...
				<div class="col-md-6 col-lg-2 col-xlg-3">
					<div class="card card-hover">
						<a href="<?php echo base_url();?>contactus">
							...
							<h6 class="text-white">BM Report</h6>
							</div>
						</a>
					</div>
				</div>
						...
						<div class="card-body">
							<div class="d-md-flex align-items-center">
								<div>
									...
									<h5 class="card-subtitle">Overview of SuiteCRM</h5>
								</div>
							</div>
							<div class="row">
								<!-- column -->
									...
									<div class="row">
										...
										<div class="col-6">
											<div class="bg-dark p-10 text-white text-center">
												...
												<h5 class="m-b-0 m-t-5">0</h5>
												<small class="font-light">From Facebook</small>
											</div>
										</div>
										<div class="col-6 m-t-15">
											<div class="bg-dark p-10 text-white text-center">
												...
												<h5 class="m-b-0 m-t-5">0</h5>
												<small class="font-light">From WB</small>
											</div>
										</div>
										<div class="col-6 m-t-15">
											<div class="bg-dark p-10 text-white text-center">
												...
												<h5 class="m-b-0 m-t-5">0</h5>
												<small class="font-light">From USA</small>
											</div>
										</div>
										<div class="col-6 m-t-15">
											<div class="bg-dark p-10 text-white text-center">
										...
										<div class="col-6 m-t-15">
											<div class="bg-dark p-10 text-white text-center">
												<i class="fa fa-globe m-b-5 font-16"></i>
												<h5 class="m-b-0 m-t-5">0</h5>
												<small class="font-light">Total Brochures</small>
											</div>
										</div>
